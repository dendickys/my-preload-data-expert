package com.example.mypreloaddataexpert.services;
...
import com.example.mypreloaddataexpert.pref.AppPreference;
...
public class DataManagerService extends Service {
    ...
    */
    ...
    public static class LoadDataAsync extends AsyncTask<Void, Integer, Boolean> {
        ...
        LoadDataAsync(Context context, LoadDataCallback weakCallback) {
